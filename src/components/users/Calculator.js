...
const Calculator =()=>
{
    ...
    return(
        ...
        <div className="wrapper">
          ...
          (<NumberFormate value={input} display={"text"} thousandSeperator={true}/>):(<NumberFormate value={preState} displayType={"text"} thousandSeperator={true}/>)}
        </div>
         <div className="btn btn-light-gray" onClick={reset}>AC</div> 
         <div className="btn btn-light-gray" onClick={percent}>%</div> 
         <div className="btn btn-light-gray" onClick={minusPlus}>+/-</div> 
